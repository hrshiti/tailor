                    ...
                    >
                        ...
                        <div className="p-5 flex flex-col gap-3">
                            <div className="flex justify-between items-center -mb-1">
                                ...
                                <div className="flex items-center gap-1 bg-pink-50 px-2 py-0.5 rounded-md text-[10px] font-black text-[#FF5C8A]">
                            ...
                            <div>
                                ...
                                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mt-1">
                                    Available At: <span className="text-[#FF5C8A]">{storeName}</span>
                                </p>
                            </div>

                            <div className="flex items-baseline gap-2 mt-1">
                                <span className="text-2xl font-black text-[#FF5C8A]">₹{price}</span>
                            ...
                            <div className="bg-gray-50 border border-gray-100 rounded-xl p-3 flex flex-col gap-2 shadow-inner mt-1">
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-xs font-black text-[#FF5C8A]">₹{estStitching}</span>
                                </div>
                                ...
                                <div className="flex justify-between items-center">
                                    ...
                                    <span className="text-sm font-black text-[#FF5C8A]">₹{totalPrice}*</span>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 mt-4 pt-1">
                                ...
                                <button 
                                    ...
                                    disabled={isAdding}
                                    className="flex-1 bg-[#FF5C8A] text-white rounded-[1.2rem] font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 active:scale-95 transition-all shadow-xl shadow-pink-900/20 disabled:opacity-50"
                                >
                                    {isAdding ? "Adding..." : (
                                        <>
