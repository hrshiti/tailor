    ...
    if (isLoading) {
        return (
            <div className="px-4 py-8 flex flex-col items-center justify-center gap-2">
                <Loader2 size={24} className="animate-spin text-[#1e3932]" />
                ...
                {services.map((service) => (
                    ...
                    >
                        ...
                        <div className="px-1">
                            ...
                            <p className="text-xs text-gray-500 mt-1">Starts from <span className="font-bold text-[#1e3932]">₹{service.basePrice}</span></p>
                        </div>
                    </div>
                ))}
            </div>
